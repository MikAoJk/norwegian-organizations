...
export const OrganizationsOnGithub = () => {
    ...
    return (
        <div className="relative overflow-x-auto">
            <a className="flex flex-col items-center mb-4" href="https://github.com/MikAoJk/norwegian-organizations">
                <svg width="3em" height="3em" viewBox="0 0 98 98" xmlns="http://www.w3.org/2000/svg"
                     aria-labelledby="github-icon-title" role="img"><title id="github-icon-title">Norwegian organizations repo on Github</title>
            ...
            <h1 className="text-l md:text-4xl font-extrabold mb-8 md:mb-12 text-center">Norwegian organizations
                on
                GitHub</h1>
            {
